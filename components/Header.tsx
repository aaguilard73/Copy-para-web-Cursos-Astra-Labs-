  ...
  return (
    <header className="bg-white/50 dark:bg-deep-blue/50 backdrop-blur-lg sticky top-0 z-40 shadow-md">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:justify-between items-center py-4 gap-4 sm:gap-0">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-semibold text-deep-blue dark:text-warm-gray-light">
              Formaciones
            </h1>
          </div>
          <div className="flex items-center flex-wrap justify-center gap-2 sm:gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-1.5 text-sm font-semibold text-vibrant-blue bg-white/80 dark:bg-deep-blue/80 border border-vibrant-blue/30 rounded-full hover:bg-vibrant-blue/10 dark:hover:bg-vibrant-blue/20 transition-colors duration-300"
            >
              Volver al inicio
            </a>
